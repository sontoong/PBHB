...
pyinstaller --clean --onedir --hide-console "minimize-early" --name "PBHB" --add-data "$ADD_DATA_FLAG" --additional-hooks-dir=. bh_bot/__main__.py

pyinstaller --clean --onedir --noconsole --name "PBHB-no-console" --add-data "$ADD_DATA_FLAG" --additional-hooks-dir=. bh_bot/__main__.py
