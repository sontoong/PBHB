...
from bot.managers import ProfileManager, CredentialManager
...
class SettingsDialog:
    ...
    def _build(self, profile: dict, creds: dict):
        ...
        ProfileTab(self._username, creds, self._context,
    ...
    async def _fetch_and_populate(self):
        ...
        creds = await CredentialManager(self._username, self._context).load_credentials()
        self._context.queue_ui_task(lambda: self._build(profile, creds))
